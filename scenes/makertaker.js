...
const makerTakerScene = new Scenes.WizardScene(
    'MAKER_TAKER_SCENE',
    (ctx) => {
    ...
    async (ctx) => {
        ...
        const P2pSellOffers = P2pOffers.filter(offer => offer.tradeType === "BUY" && offer.bank === bank);
        ...
        for (let offer of P2pSellOffers) {
            for (let coin of coins) {
                ...
                const coinPrices = P2pOffers.filter(a => a.tradeType === "BUY" && a.asset === coin);
...
module.exports = makerTakerScene;